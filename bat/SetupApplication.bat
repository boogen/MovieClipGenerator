...
:: Android packaging
set AND_CERT_NAME="MoveClipGenerator"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MoveClipGenerator.p12
...
set IOS_PROVISION=cert\MoveClipGenerator.mobileprovision
...
set APP_ID=air.MoveClipGenerator

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MoveClipGenerator
